...
use crate::utils::{strip_ansi, truncate_chars};
...
pub(crate) struct UserToolDefinition {
    pub(crate) name: String,
    pub(crate) description: String,
    pub(crate) version: String,
    #[serde(rename = "inputSchema")]
    pub(crate) input_schema: Value,
    pub(crate) handler: UserToolHandler,
    #[serde(default)]
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub(crate) struct UserToolHandler {
    #[serde(rename = "type")]
...
pub(crate) struct UserToolLoadReport {
    pub(crate) directory: PathBuf,
    pub(crate) tools: Vec<UserToolDefinition>,
...
#[derive(Debug, Clone, Serialize)]
pub(crate) struct UserToolVisibleReport {
    pub(crate) tools: Vec<Value>,
    pub(crate) warnings: Vec<String>,
    pub(crate) total_valid: usize,
}
// END_UserToolVisibleReport

// START_UserToolMergeReport
#[derive(Debug, Clone, Serialize)]
pub(crate) struct UserToolMergeReport {
    pub(crate) warnings: Vec<String>,
    pub(crate) total_valid: usize,
    pub(crate) total_available: usize,
}
// END_UserToolMergeReport

// START_UserToolValidationReport
#[derive(Debug, Clone, Serialize)]
pub(crate) struct UserToolValidationReport {
...
pub(crate) fn builtin_tool_names(tools: &[Value]) -> BTreeSet<String> {
    tools
        .iter()
...
pub(crate) fn current_builtin_tool_names() -> BTreeSet<String> {
...
pub(crate) fn load_visible_definitions(
    directory: &Path,
    profile: &ToolProfile,
    builtin_names: &BTreeSet<String>,
...
pub(crate) fn merge_visible_definitions(
    profile: &ToolProfile,
    tools: &mut Vec<Value>,
) -> UserToolMergeReport {
...
// START_handle_call
pub(crate) async fn handle_call(id: Option<Value>, name: &str, args: &Value) -> Value {
...
pub(crate) async fn execute_tool_definition(
    tool: &UserToolDefinition,
    args: &Value,
...
pub(crate) fn new_tool_template(name: &str) -> Value {
    serde_json::json!({
        "name": name,

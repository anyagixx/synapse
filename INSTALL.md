...
```bash
curl -fsSL https://raw.githubusercontent.com/anyagixx/synapse/v2.7.0/install.sh -o /tmp/synapse-install.sh
...
```bash
cargo install --locked --git https://github.com/anyagixx/synapse --tag v2.7.0
```

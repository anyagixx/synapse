...
[![CI](https://github.com/anyagixx/synapse/actions/workflows/ci.yml/badge.svg)](https://github.com/anyagixx/synapse/actions/workflows/ci.yml)
[![Release](https://img.shields.io/github/v/release/anyagixx/synapse?label=release)](https://github.com/anyagixx/synapse/releases)
...
curl -fsSL https://raw.githubusercontent.com/anyagixx/synapse/v2.7.5/install.sh | sh

# Custom install directory without sudo
curl -fsSL https://raw.githubusercontent.com/anyagixx/synapse/v2.7.5/install.sh | SYN_INSTALL_DIR="$HOME/.local/bin" sh

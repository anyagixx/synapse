...
> *31 MCP tools. Sharded Phase 0 gate. Self-verified. Zero overhead for humans.*
...
- Даёт LLM **31 MCP-инструмент** для поиска, проверки и генерации кода
...
opencode          # LLM видит 31 MCP инструмент + sharded Phase 0 gate
...
| **GRACE** | Sharded Phase 0 gate, MODULE_CONTRACT/MAP/CHANGE_SUMMARY, 31 MCP tools, 15 workflow tools, 3 режима ревью |
...
| Тестов | **136** (cargo test --all-targets) |

...
// INPUTS: { args: &serde_json::Value }, { response: &mut serde_json::Value }, { pressure: &syn_core::tracking::ContextPressure }
...
fn attach_pressure_fields(
    args: &serde_json::Value,
    response: &mut serde_json::Value,
    pressure: &syn_core::tracking::ContextPressure,
) {
...
mod tests {
    ...
    // OUTPUTS: { syn_core::tracking::ContextPressure }
    // START_test_pressure
    fn test_pressure(pressure_pct: f64, level: PressureLevel) -> syn_core::tracking::ContextPressure {
        syn_core::tracking::ContextPressure {

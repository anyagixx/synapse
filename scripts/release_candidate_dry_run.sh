...
# SCOPE: Tag/version guard, generated release notes policy, checksum aggregation policy, Linux/macOS installer dry-run mapping, GitHub step-summary evidence, and optional local release smoke.
...
# check_installer_matrix - Validates Linux/macOS x86_64 and arm64 installer mappings
...
# LAST_CHANGE: [v1.1.0 - Added Phase 10 release-candidate evidence summary]
# END_CHANGE_SUMMARY
...
# OUTPUTS: { exit code 0 - release workflow declares notes, checksums, and all Linux/macOS artifacts }
...
# SIDE_EFFECTS: executes install.sh --dry-run four times
...
# INPUTS: { $1: smoke_status - skipped or executed }
...
write_step_summary "$smoke_status"

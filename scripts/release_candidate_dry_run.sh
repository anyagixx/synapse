...
# SCOPE: Tag/version guard, generated release notes policy, checksum aggregation policy, Linux/macOS installer dry-run mapping, and optional local release smoke.
...
# LAST_CHANGE: [v1.0.0 - Added Phase 9 release candidate dry-run gate]
# END_CHANGE_SUMMARY
...
# SIDE_EFFECTS: invokes release_version_guard.sh, install.sh --dry-run, and optionally release_install_smoke.sh

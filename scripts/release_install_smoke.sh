...
# SCOPE: Supported Linux/macOS x86_64/aarch64 release build, tarball packaging, SHA256 checksum verification, extraction, executable check, and Cargo.toml version smoke.
...
# LAST_CHANGE: [v1.6.0 - Restored Intel macOS release-smoke target]
# END_CHANGE_SUMMARY
...
case "${host_os}:${host_arch}" in
    ...
    Darwin:x86_64|Darwin:amd64) default_target="x86_64-apple-darwin" ;;

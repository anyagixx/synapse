...
# SCOPE: Release build, Linux tarball packaging, extraction, executable check, and version smoke.
# DEPENDS: M-BUILD, M-INSTALL
# LINKS: .github/workflows/ci.yml, .github/workflows/release.yml, install.sh

# START_MODULE_MAP
# run_release_install_smoke - Builds, packages, extracts, and executes the Linux release artifact
# END_MODULE_MAP

# START_CHANGE_SUMMARY
# LAST_CHANGE: [v1.0.0 - Initial release/install smoke gate]
# END_CHANGE_SUMMARY

# START_CONTRACT_run_release_install_smoke
# PURPOSE: Validate that the release tarball layout can be extracted and executed by installer consumers

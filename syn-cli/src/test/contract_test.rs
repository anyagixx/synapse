...
use syn_engine::grace::cascade::ImpactAnalysis;
...
fn run_contract_test_suite(
    ...
    {
        let analysis = syn_engine::grace::cascade::cascade_impact(
            root,
...
mod tests {
    use super::*;
    use syn_engine::grace::cascade::{AffectedModule, ImpactLevel};

...
// START_MODULE_MAP
// test_initialize_then_list_tools — MCP handler lists all 36 tools after initialize
...
// LAST_CHANGE: [v2.20.0 — Updated MCP tool count for agent-based testing tools]
// END_CHANGE_SUMMARY

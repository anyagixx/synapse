...
// START_MODULE_MAP
// test_initialize_then_list_tools — MCP handler lists all 32 tools after initialize
...
// LAST_CHANGE: [v2.17.0 — Updated MCP tool count for generate_development_plan]
// END_CHANGE_SUMMARY

...
impl RunManager {
    ...
    // INPUTS: { report: &syn_engine::grace::traceability::TraceabilityReport }
    ...
    pub fn traceability_plan(
        &self,
        report: &syn_engine::grace::traceability::TraceabilityReport,
    ) -> RunPlanningHint {
    ...
    // INPUTS: { phase: &str }, { module_id: &str }, { report: &syn_engine::grace::status::StatusReport }
    ...
    // INPUTS: { goal: &str }, { phase: &str }, { module_id: &str }, { objective: &str }, { report: &syn_engine::grace::status::StatusReport }
...
mod tests {
    ...
    fn run_manager_blocks_when_mental_tests_missing() {
        ...
        let rt = tokio::runtime::Builder::new_current_thread()
            ...
            .build()
            .unwrap();
        let report = rt.block_on(syn_engine::grace::status::StatusCollector::collect(root.path()));
    ...
    fn traceability_plan_turns_gaps_into_tasks() {
        ...
        let report = syn_engine::grace::traceability::TraceabilityReport {
            ...
            gaps: vec![syn_engine::grace::traceability::TraceGap {
